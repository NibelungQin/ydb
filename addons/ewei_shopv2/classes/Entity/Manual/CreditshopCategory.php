...
/**
 * ImsEweiShopCreditshopCategory
 *
 * @ORM\Table(name="ims_ewei_shop_creditshop_category", indexes={@ORM\Index(name="idx_enabled", columns={"enabled"}), @ORM\Index(name="idx_uniacid", columns={"uniacid"}), @ORM\Index(name="idx_displayorder", columns={"displayorder"})})
 * @ORM\Entity
 */
class CreditshopCategory
{
    public const TABLE_NAME = 'ims_ewei_shop_creditshop_category';
