 ...
 * ImsCorePaylog
 *
 * @ORM\Table(name="ims_core_paylog", indexes={@ORM\Index(name="idx_tid", columns={"tid"}), @ORM\Index(name="uniontid", columns={"uniontid"}), @ORM\Index(name="idx_openid", columns={"openid"}), @ORM\Index(name="idx_uniacid", columns={"uniacid"})})
 * @ORM\Entity
 */
class CorePaylog
{
    public const TABLE_NAME = 'ims_core_paylog';

    /**
     * @var int
     *
     * @ORM\Column(name="plid", type="bigint", nullable=false, options={"unsigned"=true})
     * @ORM\Id
     ...
     * @var string
     *
     * @ORM\Column(name="uniontid", type="string", length=64, nullable=false)
     */
    private $uniontid;
     ...
     * @var string
     *
     * @ORM\Column(name="tid", type="string", length=128, nullable=false)
     */
    private $tid;
