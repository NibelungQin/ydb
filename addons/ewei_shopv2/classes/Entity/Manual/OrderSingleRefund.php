 ...
 * OrderSingleRefund
 *
 * @Table(name="ims_ewei_shop_order_single_refund",
 *      indexes={
 *          @Index(name="idx_createtime", columns={"createtime"}),
 *          @Index(name="idx_uniacid", columns={"uniacid"})})
 * @Entity
 */
class OrderSingleRefund
{
    public const TABLE_NAME = 'ims_ewei_shop_order_single_refund';
     ...
     * @var int|null
     *
     * @Column(name="ordergoodsid", type="integer", nullable=true)
     */
    private $ordergoodsid = '0';
     ...
     * @var string|null
     *
     * @Column(name="ordergoodsrealprice", type="decimal", precision=10, scale=2, nullable=true, options={"default"="0.00"})
     */
    private $ordergoodsrealprice = '0.00';
     ...
     * @var int
     *
     * @Column(name="tradetype", type="smallint", nullable=false)
     */
    private $tradetype = '0';
     ...
     * @var int|null
     *
     * @Column(name="issuporder", type="smallint", nullable=true)
     */
    private $issuporder = '0';

    /**
     * @var int|null
     *
     * @Column(name="suptype", type="smallint", nullable=true)
     */
    private $suptype = '0';
     ...
     * @return string|null
     */
    public function getOrdergoodsrealprice(): ?string
    {
        return $this->ordergoodsrealprice;
    }

    /**
     * @param string|null $ordergoodsrealprice
     */
    public function setOrdergoodsrealprice(?string $ordergoodsrealprice): void
    {
        $this->ordergoodsrealprice = $ordergoodsrealprice;
    }
     ...
     * @return int|null
     */
    public function getIssuporder(): ?int
    {
        return $this->issuporder;
    }

    /**
     * @param int|null $issuporder
     */
    public function setIssuporder(?int $issuporder): void
    {
        $this->issuporder = $issuporder;
    }
    ...
    /**
     * @param int|null $suptype
     */
    public function setSuptype(?int $suptype): void
    {
