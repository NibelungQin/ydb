...
/**
 * ImsEweiShopPackagegoodsAchievementLog
 *
 * @ORM\Table(name="ims_ewei_shop_packagegoods_achievement_log")
 * @ORM\Entity
 */
class PackagegoodsAchievementLog
{
    public const TABLE_NAME = 'ims_ewei_shop_packagegoods_achievement_log';
