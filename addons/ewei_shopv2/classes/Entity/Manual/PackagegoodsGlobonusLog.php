...
/**
 * ImsEweiShopPackagegoodsGlobonusLog
 *
 * @ORM\Table(name="ims_ewei_shop_packagegoods_globonus_log")
 * @ORM\Entity
 */
class PackagegoodsGlobonusLog
{
    public const TABLE_NAME = 'ims_ewei_shop_packagegoods_globonus_log';
