...
if (!function_exists('show_json')) {
    function show_json($status = 1, $return = null)
    {
        ...
        if (!is_array($return)) {
            ...
            ExceptionUtil::die(json_encode($ret), $status !== 1);
        } else {
            $ret['result'] = $return;
        }
...
if( !function_exists('is_h5app') ) {
	function is_h5app()
	{
        return !empty($_SERVER['HTTP_USER_AGENT']) && strpos($_SERVER['HTTP_USER_AGENT'], 'Html5Plus');
    }
}
...
if( !function_exists('is_mobile') ) {
	function is_mobile()
	{
        ...
        return preg_match("/(android|bb\\d+|meego).+mobile|avantgo|bada\\/|blackberry|blazer|compal|elaine"
                . '|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront'
            ...
            || preg_match("/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\\-)|ai(ko|rn)"
                ...
                . "|jbro|jemu|jigs|kddi|keji|kgt( |\\/)|klon|kpt |kwc\\-|kyo(c|k)|le(no|xi)|lg( g|\\/(k|l|u)|50|54"
                ...
                . "|pt\\-g|qa\\-a|qc(07|12|21|32|60|\\-[2-7]|i\\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\\/"
                ...
                . "|tx\\-9|up(\\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\\-v)|vm40|voda|vulc|vx(52|53|60"
                . "|61|70|80|81|83|85|98)|w3c(\\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\\-|your|zeto|zte\\-/i",
...
function cloud_upgrade($type, $post_data = array(), $timeout = 60) {
    ...
    $resp = ihttp_request("http://baidu.com", $post_data, $extra, $ip, $timeout);
