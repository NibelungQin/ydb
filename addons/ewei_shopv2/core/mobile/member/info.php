...
class Member_Info_EweiShopV2MobilePage extends MobileLoginPage
{
    protected $member;
    ...
    public function submit()
    {
        ...
        if ($template_flag == 1) {
            ...
            pdo_update('ewei_shop_member', $m_data,
                array('openid' => $_W['openid'], 'uniacid' => $_W['uniacid']));

            if (!empty($this->member['uid']) && !empty($mc_data)) {
            ...
            $arr = array(
                ...
                'birthyear' => (int)$memberdata['birthyear'],
                'birthmonth' => (int)$memberdata['birthmonth'],
                'birthday' => (int)$memberdata['birthday'],
                ...
                'nickname' => trim($memberdata['nickname']),
                'avatar' => trim($memberdata['avatar'])
            );
    ...
    public function face()
    {
        ...
        if ($_W['ispost']) {
            ...
            pdo_update('ewei_shop_member', array('avatar' => $avatar, 'nickname' => $nickname),
