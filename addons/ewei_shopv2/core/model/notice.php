...
联系电话: ' . $carrier['carrier_mobile'];
		...
		if ($delRefund) {
			...
			if (!empty($order['refundid'])) {
				...
				$datas[] = array('name' => '售后类型', 'value' => OrderRefund::REFUND_TYPE[$refund['rtype']]);
...
请登录后台查看维权详情。', 'color' => '#ff0000'),
							'keyword2' => array('title' => '处理进度', 'value' => OrderRefund::REFUND_TYPE[$refund['rtype']] . '申请', 'color' => '#000000'),
...
感谢您关注，如有疑问请联系在线客服或点击查看详情', 'color' => '#000000')
					...
					if ($refund['status'] == -1) {
						...
						$remark = '
感谢您关注，如有疑问请联系在线客服或<a href=\'' . $url . '\'>点击查看详情</a>';
						$text = '您好，你那有一笔' . OrderRefund::REFUND_TYPE[$refund['rtype']] . '被驳回，您可以与我们取得联系！
...
感谢您关注，如有疑问请联系在线客服或点击查看详情';
						$msg = array(
							'first'    => array('value' => '您好，你有一笔' . OrderRefund::REFUND_TYPE[$refund['rtype']] . '被驳回，您可以与我们取得联系！
', 'color' => '#ff0000'),
							'keyword2' => array('title' => '处理进度', 'value' => '退换货申请', 'color' => '#000000'),
