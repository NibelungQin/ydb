...
class System_Data_Index_EweiShopV2WebPage extends SystemPage
{
		...
		if ($_W['ispost']) {
			...
			if (is_array($_GPC['shop'])) {
				foreach ($_GPC['shop'] as $data) {
                    ...
                    }else if ($data == 'globonus') {
                        pdo_query('delete from  ' . tablename('ewei_shop_globonus_bill') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_globonus_billo') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_globonus_billp') . (' where 1 ' . $condition));
					}else if ($data == 'abonus') {
                        pdo_query('delete from  ' . tablename('ewei_shop_abonus_bill') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_abonus_billo') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_abonus_billp') . (' where 1 ' . $condition));
                    }else if ($data == 'achievement') {
                        pdo_query('delete from  ' . tablename('ewei_shop_achievement_bill') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_achievement_billo') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_achievement_billp') . (' where 1 ' . $condition));
                    }else if ($data == 'attractshop') {
                        pdo_query('delete from  ' . tablename('ewei_shop_attractshop_bill') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_attractshop_billo') . (' where 1 ' . $condition));
                        pdo_query('delete from  ' . tablename('ewei_shop_attractshop_billp') . (' where 1 ' . $condition));
                    }
