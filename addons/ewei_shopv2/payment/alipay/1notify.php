...
require_once(IA_ROOT . "/addons/ewei_shopv2/core/inc/functions.php");
...
class aliApy 
{
	...
	public function __construct() 
	{
		global $_W;
		$this->post = $_POST;
      	$str = json_encode($this->post,JSON_FORCE_OBJECT);
	...
	public function order() 
	{
		...
		$log = pdo_fetch($sql, $params);
      	//$log = pdo_fetch("select * from " . tablename("ewei_shop_order") . " where ordersn=:id limit 1", array( ":ordersn" => $tid ));
      	//$log['fee'] = $log['price'];
