...
class Orders_EweiShopV2Page extends PluginMobileLoginPage 
{
	...
	public function confirm() 
	{
		...
		else if (($type == 'single') && ($goods['more_spec'] == 1)) 
		{
		...
		else if (($type == 'groups') && !(empty($ladder)) && ($goods['is_ladder'] == 1)) 
		{
		...
		else if (($type == 'groups') && !(empty($option)) && ($goods['more_spec'] == 1)) 
		{
