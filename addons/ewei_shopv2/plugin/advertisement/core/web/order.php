...
class Order_EweiShopV2Page extends PluginWebPage 
{
	public function main() 
	{
		...
		$list = pdo_fetchall('SELECT o.id,o.orderno,o.status,o.expresssn,o.paytime,o.addressid,o.express,o.remark,o.is_team,o.pay_type,o.isverify,o.refundtime,o.price,o.creditmoney,o.refundstate,o.refundid,' . "\r\n\t\t\t\t" . 'o.freight,o.discount,o.creditmoney,o.createtime,o.success,o.deleted,o.address,o.message,o.openid,g.thumb_url,op.title as optnisname,' . "\r\n\t\t\t\t"
