...
', $activitySetting['desc']);
		...
		app_json(array('coupon' => $coupon, 'success' => $success, 'isReceive' => $isReceive, 'isShare' => $isShare, 'currentActivityInfo' => $currentActivityInfo, 'overTime' => $overTime, 'overPeople' => $overPeople, 'activityData' => $activityData, 'activitySetting' => $activitySetting, 'share_user' => $share_user, 'invalidMessage' => $tips, 'isLogin' => (bool) $user, 'mylink' => $mylink));
	}
