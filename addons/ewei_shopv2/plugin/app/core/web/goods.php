...
class App_Goods_EweiShopV2PluginWebPage extends PluginWebPage
{
    ...
    public function get_code()
    {
        ...
        $img = intval($_GPC['img']);
        $id = intval($_GPC['id']);
        $ret = $this->model->getCodeUnlimit(array(
            'scene' => 'id=' . $id,
            'page' => empty($id) ? 'pages/goods/index/index' : 'pages/goods/detail/index'
        ));
