...
class App_Release_EweiShopV2PluginWebPage extends PluginWebPage
{
    ...
    public function audit()
    {
        ...
        if ($action == 'upload') {
            ...
            $request = ihttp_post(EWEI_SHOPV2_AUTH_WXAPP . 'index/index/submitCode4.html?ver=31231&site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'],
                array('tabBar' => $tabBar));
        } else {
            $request = ihttp_post(EWEI_SHOPV2_AUTH_WXAPP . 'index/index/auditCode.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'],
                array());
        }
        if ($request["code"] != 200) {
