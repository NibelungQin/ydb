...
class Commission_Apply_EweiShopV2PluginWebPage extends PluginWebPage
{
	...
	public function refuse() 
	{
		...
		pdo_update('ewei_shop_commission_apply', array('status' => -1, 'checktime' => 0, 'invalidtime' => 0, 'refusetime' => time()), array('id' => $id, 'uniacid' => $_W['uniacid']));
	...
	public function pay($params = array(), $mine = array()) 
	{
		...
		$this->model->upgradeLevelByAgent($member['openid']);
		if (p('globous')) 
		{
			p('globous')->upgradeLevelByAgent($member['openid']);
		}
