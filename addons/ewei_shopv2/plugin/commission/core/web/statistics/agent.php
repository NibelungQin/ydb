...
class Commission_Statistics_Agent_EweiShopV2PluginWebPage extends PluginWebPage
{
	public function main()
	{
		...
		$array = array('total', 'pay', 'ordercount0', 'ordermoney0', 'ordercount', 'ordermoney', 'ordercount3', 'ordermoney3','current_money');
		...
		foreach ($list as &$row) {
            ...
            $row['current_commission_total'] = $info['current_commission_total'];
		...
		if ($_GPC['export'] == '1') {
			...
			$columns = array(
                ...
                array('title' => '统计佣金', 'field' => 'current_commission_total', 'width' => 12),
