    ...
    function(core, tpl, picker) {
        ...
        modal.initSelect = function() {
            ...
            $("body").on("click",".edit",function () {
                ...
                console.log(index);
                $("#goods-container").find(".goods-selected").eq(index).find("input").show(100);
                var cur = $(this).text();
                if (cur) {
                    if(cur == '编辑'){
            ...
            $("body").on("click",".queren",function () {
                ...
                var price=parseFloat(_this.prev('div').find('input').val());
                core.json('commission/myshop/select/edit_price', {
                    goods_id:goods_id,
                    price:price,
                    ...
                    function(pjson) {
                        if (pjson.status == 0) {
                            ...
                            $("#goods-container").find(".goods-selected").eq(index).find(".show_price").text('￥'+price);

                        }
                        var index=$(".edit").index(_this);
                        $("#goods-container").find(".goods-selected").eq(index).find("input").hide(100);
                        _this.removeClass('queren');
                        _this.text( '编辑');
                ...
                // var index=$(".edit").index($(this));
                // console.log(index);
                // $("#goods-container").find(".goods-selected").eq(index).find(".bigprice").toggleClass("oldprice");
                // $("#goods-container").find(".goods-selected").eq(index).find("input").toggle(100);
                // var cur = $(this).text();
                // if (cur) {
                //     if(cur == '编辑'){
                //         $(this).addClass('queren');
                //     }
                //     $(this).text(cur == '编辑' ? '确认' : '编辑');
                // }
