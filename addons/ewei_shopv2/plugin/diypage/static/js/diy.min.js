define(['jquery.ui', '../../../../static/js/web/goods_selector.js'], function (ui, gSelector) {
    ...
    modal.initNavs = function () {
        modal.getNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'pictures', 'icongroup', 'audio', 'coupon','tabbar', 'topmenu','video'],
    ...
    modal.initTemp = function () {
        ...
        $("#saveTemp", "#saveTempModal").unbind('click').click(function () {
            ...
            $.post(posturl, {jsonData: jsonData}, function (ret) {
                if (ret.status == 0) {
    ...
    modal.initTpl = function () {
        tpl.helper("imgsrc", function (src) {
            ...
            }else if (src.indexOf('videos/') == 0 || src.indexOf('audios/') == 0) {
                return modal.attachurl + src
            }
        });
    ...
    modal.save = function (preview) {
        ...
        if (modal.type == 1) {
            ...
            var jsonData = {id: modal.id, data: modal.data};
            jsonData = JSON.stringify(jsonData);
            $.post(posturl, {jsonData: jsonData}, function (ret) {
            if (ret.status == 0) {
                tip.msgbox.err(ret.result.message);
