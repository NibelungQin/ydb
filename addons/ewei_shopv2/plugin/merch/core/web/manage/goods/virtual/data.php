...
class Merch_Goods_Virtual_Data_EweiShopV2MerchWebPage extends MerchWebPage
{
	...
	public function import() 
	{
		...
		foreach ($newRow as $rownum => $col ) 
		{
			...
			$data = array( 'typeid' => $id, 'pvalue' => $col['key'], 'fields' => array(), 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid'], 'status' => $col['status'] );
			unset($col['status']);
