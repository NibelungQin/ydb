...
class Merch_Order_Index_EweiShopV2MerchWebPage extends MerchWebPage
{
	...
	public function ajaxtransaction() 
	{
		...
		$result = array(
            ...
            'price_value' => is_array($transaction['price']) ? array_values($transaction['price']) : [],
            'count_value' => is_array($transaction['count']) ? array_values($transaction['count']) : [],
            'allprice_value' => is_array($alltransaction['price']) ? array_values($alltransaction['price']) : [],
            'allcount_value' => is_array($alltransaction['count']) ? array_values($alltransaction['count']) : []
        );
