...
class Sale_EweiShopV2Page extends WebPage 
{
	public function main() 
	{
		...
		if ($_GPC['export'] == 1) 
		{
			...
			m('excel')->export($list, array( 'title' => '大礼包交易报告-' . ((!(empty($year)) && !(empty($month)) ? $year . '年' . $month . '月' : $year . '年')), 'columns' => array( array('title' => $dataname, 'field' => 'data', 'width' => 12), array('title' => $typename, 'field' => 'count', 'width' => 12), array('title' => '所占比例(%)', 'field' => 'percent', 'width' => 24) ) ));
			plog('packagegoods.sale.export', '导出大礼包销售统计');
		}
