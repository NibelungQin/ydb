        ...
        modal.init = function(id, is_ladder, more_spec) {
            ...
            $("a.btn-single").bind("click",
                function() {
                    ...
                    core.json('packagegoods/goods/goodsCheck', {
                            'id': modal.params.id,
                            type: 'single'
                        },
                        function(postjson) {
                            ...
                            if (postjson.status == 1 && postjson.result.specArr.length > 0) {
                                ...
                                $(".select").on('click', 'div',
                                    function() {
                                        ...
                                        if (spec_id.length > 0) {
                                            core.json('packagegoods/goods/get_option', {
                                                    'spec_id': spec_id
                                                },
                                                function(spec_json) {
                                ...
                                $("div.sure").bind("click",
                                    function() {
                                        ...
                                        location.href = core.getUrl('packagegoods/orders/confirm', {
                                            id: modal.params.id,
                                            type: 'single',
                            ...
                            if (postjson.status == 1 && postjson.result.ladder.length > 0) {
                                ...
                                $("div.btn-jieti").bind("click",
                                    function() {
                                        ...
                                        modal.params.is_ladder = is_ladder;
                                        location.href = core.getUrl('packagegoods/goods/fightGroups', {
                                            id: modal.params.id,
                                            is_ladder: modal.params.is_ladder,
                                            ladder_id: ladder
                                        });
