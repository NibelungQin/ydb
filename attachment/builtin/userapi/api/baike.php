...
if ($resp['code'] == 200 && $resp['content']) {
    if (preg_match_all('/<div class="item"><h3><a href="(?P<link>.+?)">(?P<title>.+?)<\/a><\/h3><p>(?P<description>.+?)...<\/p><\/div>/',
        $resp['content'], $matchs)) {
        $ds = array();
        ...
        $news[] = array(
            ...
            'picurl' => 'http://g.hiphotos.baidu.com/baike/c0%3Dbaike180%2C5%2C5%2C180%2C60/sign=f38225303901213fdb3e468e358e5db4/9358d109b3de9c82afcae8666c81800a18d8bc3eb0356b97.jpg',
            'url' => $ds[0]['link']
        );
        $cnt = min(count($ds), 8);
        for ($i = 0; $i < $cnt; $i++) {
