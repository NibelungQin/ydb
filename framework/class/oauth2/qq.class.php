...
define('QQ_PLATFORM_API_GET_USERINFO',
...
class Qq extends OAuth2Client
{
    ...
    public function getAccessToken($state, $code)
    {
        ...
        $access_url = sprintf(QQ_PLATFORM_API_GET_ACCESS_TOKEN, $this->ak, $this->sk, $code,
