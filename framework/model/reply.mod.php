...
{
    global $_W;
    $rule_setting_select = pdo_getcolumn('uni_account_modules',
...
function reply_insert_without_service($file)
{
    ...
    $rule_keyword_info = array(
        'rid' => $rule_id,
        'uniacid' => 0,
        'module' => 'userapi',
        'displayorder' => $rule_info['displayorder'],
    ...
    $userapi_reply = array(
        'rid' => $rule_id,
        'description' => htmlspecialchars($all_service[$file]['description']),
        'apiurl' => $file
    );
