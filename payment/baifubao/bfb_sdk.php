...
class bfb_sdk
{
    ...
    {
        $params = array(
            'service_code' => sp_conf::BFB_QUERY_INTERFACE_SERVICE_ID,
            'sp_no' => sp_conf::$SP_NO,
            'order_no' => $order_no,
            'output_type' => sp_conf::BFB_INTERFACE_OUTPUT_FORMAT,
            'output_charset' => sp_conf::BFB_INTERFACE_ENCODING,
        ...
        if (is_array($params)) {
            if (ksort($params)) {
                ...
                if ($params ['sign_method'] == sp_conf::SIGN_METHOD_MD5) {
                    ...
                    if ($params ['sign_method'] == sp_conf::SIGN_METHOD_SHA1) {
