...
$we7_system_menu['account'] = array(
    ...
    'url' => web_url('home/welcome/platform'),
    'section' => array(
        'platform_plus' => array(
            'title' => '增强功能',
            'menu' => array(
                ...
                'platform_menu' => array(
                    'title' => '自定义菜单',
                    'url' => web_url('platform/menu/post'),
                    'icon' => 'wi wi-custommenu',
                    'permission_name' => 'platform_menu',
                ),
                'platform_qr' => array(
                    'title' => '二维码/转化链接',
                    'url' => web_url('platform/qr'),
                    'icon' => 'wi wi-qrcode',
                ...
                'platform_site' => array(
                    'title' => '微官网-文章',
                    'url' => web_url('site/multi/display'),
                    'icon' => 'wi wi-home',
        ...
        'profile' => array(
            ...
            'menu' => array(
                ...
                'bind_domain' => array(
                    'title' => '域名绑定',
                    'url' => web_url('profile/bind-domain'),
                    'icon' => 'wi wi-parameter-setting',
...
$we7_system_menu['wxapp'] = array(
    ...
    'url' => web_url('wxapp/display/home'),
    'section' => array(
        'wxapp_entrance' => array(
            ...
            'menu' => array(
                'module_entrance_link' => array(
                    'title' => "入口页面",
                    'url' => web_url('wxapp/entrance-link'),
                    'is_display' => 1,
                    'icon' => 'wi wi-data-synchro',
        ...
        'wxapp_profile' => array(
            ...
            'menu' => array(
                'wxapp_module_link' => array(
                    'title' => "数据同步",
                    'url' => web_url('wxapp/module-link-uniacid'),
                    'is_display' => 1,
                    'icon' => 'wi wi-data-synchro',
                ...
                'front_download' => array(
                    'title' => '上传微信审核',
                    'url' => web_url('wxapp/front-download'),
                    'is_display' => 1,
                    'icon' => 'wi wi-examine',
...
$we7_system_menu['system'] = array(
    'title' => '系统',
    'icon' => 'wi wi-setting',
    'url' => web_url('home/welcome/system'),
    'section' => array(
        'wxplatform' => array(
            'title' => '公众号',
            'menu' => array(
                'system_account' => array(
                    'title' => ' 微信公众号',
                    'url' => web_url('account/manage', array('account_type' => '1')),
                    'icon' => 'wi wi-wechat',
        ...
        'module' => array(
            ...
            'menu' => array(
                'system_wxapp' => array(
                    'title' => '微信小程序',
                    'url' => web_url('account/manage', array('account_type' => '4')),
                    'icon' => 'wi wi-wxapp',
                ...
                'system_module_wxapp' => array(
                    'title' => '小程序应用',
                    'url' => web_url('module/manage-system', array('account_type' => '4')),
        ...
        'welcome' => array(
            ...
            'menu' => array(
                'system_welcome' => array(
                    'title' => '系统首页应用',
                    'url' => web_url('module/manage-system', array('system_welcome' => 1)),
                    'icon' => 'wi wi-wxapp',
        ...
        'user' => array(
            ...
            'menu' => array(
                'system_my' => array(
                    'title' => '我的帐户',
                    'url' => web_url('user/profile'),
                    'icon' => 'wi wi-user',
                    'permission_name' => 'system_my',
                ),
                'system_user' => array(
                    'title' => '用户管理',
                    'url' => web_url('user/display'),
        ...
        'system_statistics' => array(
            ...
            'menu' => array(
                'system_account_analysis' => array(
                    'title' => '访问统计',
                    'url' => web_url('statistics/account'),
                    'icon' => 'wi wi-article',
        ...
        'cache' => array(
            ...
            'menu' => array(
                'system_setting_updatecache' => array(
                    'title' => '更新缓存',
                    'url' => web_url('system/updatecache'),
                    'icon' => 'wi wi-update',
