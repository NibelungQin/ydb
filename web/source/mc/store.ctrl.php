...
if ($do == 'display') {
    ...
    $total = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('activity_stores') . ' WHERE uniacid = :uniacid',
        array(':uniacid' => $_W['uniacid']));
    $list = pdo_fetchall('SELECT * FROM ' . tablename('activity_stores') . " WHERE uniacid = :uniacid {$limit}",
        array(':uniacid' => $_W['uniacid']));
