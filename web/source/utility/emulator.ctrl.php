            ...
            <div class="col-sm-8">
                <form action="" method="get" class="form-horizontal form">
                                ...
                                foreach ($accounts as $account) {
                                    ...
                                    if (!empty($account)) {
                                        ...
                                        <?php if ($development == 1) { ?>
                                            <option <?php if ($_W['acid'] == $account['acid']) { ?>selected<?php } ?>
                                        ...
                                        <?php } else { ?>
                                            <option <?php if ($_W['acid'] == $account['acid']) { ?>selected<?php } ?>
                                                    value="<?php echo $account['acid']; ?>"><?php echo $account['name'] ?></option>
                                        <?php } ?>
                                        <?php
                                    }
                                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-xs-12">
                            ...
                            <div class="radio-inline"><input type="radio" name="type" value="image" id="type_image"
                                                             onclick="toggle('image')"/><label
                                        for="type_image">&nbsp;图片</label></div>
                            <div class="radio-inline"><input type="radio" name="type" value="location"
                                                             id="type_location" onclick="toggle('location')"/><label
                                        for="type_location">&nbsp;位置</label></div>
                            <div class="radio-inline"><input type="radio" name="type" value="link" id="type_link"
                                                             onclick="toggle('link')"/><label
                                        for="type_link">&nbsp;链接</label></div>
                            <div class="radio-inline"><input type="radio" name="type" value="event" id="type_event"
                                                             onclick="toggle('event')"/><label
                                        for="type_event">&nbsp;菜单</label></div>
                            <div class="radio-inline"><input type="radio" name="type" value="subscribe"
                                                             id="type_subscribe" onclick="toggle('subscribe')"/><label
                                        for="type_subscribe">&nbsp;模拟关注</label></div>
                            <div class="radio-inline"><input type="radio" name="type" value="unsubscribe"
                                                             id="type_unsubscribe"
                                                             onclick="toggle('unsubscribe')"/><label
                                        for="type_unsubscribe">&nbsp;取消关注</label></div>
                            <div class="radio-inline"><input type="radio" name="type" value="other" id="type_other"
                                                             onclick="toggle('other')"/><label
                                        for="type_other">&nbsp;其他</label></div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-xs-12">
                            <textarea id="sendxml" rows="10" cols="50" class="form-control"
